...
class IoSystemBranch extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [[
                ...
                'batchs', 
                'allowLot', 
                'allowAutoNumberSale'], 'boolean'],
            [['idioSystem', 'iduser', 'idstatus', 'idkey', 'decimalsStock', 'idtypeEnterprise', 'readOnly_codigoSucursal', 'idstoreProduction', 'idcity', 'numPrintPrinterSilence'], 'default', 'value' => null],
            [['idioSystem', 'iduser', 'idstatus', 'idkey', 'decimalsStock', 'idtypeEnterprise', 'readOnly_codigoSucursal', 'idstoreProduction', 'idcity', 'numPrintPrinterSilence'], 'integer'],
            ...
            [['name'], 'string', 'max' => 25],
            [['codigoSucursal', 'key'], 'string', 'max' => 10],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'batchs' => 'Batchs',
            'allowLot' => 'allowLot',
            'allowAutoNumberSale' => 'allowAutoNumberSale'
        ];
    }
