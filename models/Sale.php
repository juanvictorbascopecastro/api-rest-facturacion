...
class Sale extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['idcustomer', 'idstatus', 'number', 'service', 'iddocument', 'iduser', 'idsystemPoint', 'codigoModalidad', 'codigoMetodoPago', 'codigoMoneda', 'idcash', 'idcardService', 'idcashDocument', 'codigoTipoDocumentoIdentidad', 'idorder', 'idpriceSheet', 'idtypeCharge', 'codigoDocumentoSector', 'idcustomer2', 'codigoTipoDocumentoIdentidad2'], 'default', 'value' => null],
